                                ...
                                <div class="row">
                                    <div class="col-lg-6 p-20 col-sm-offset-1">
                                        <form class="form-horizontal" method="POST"
                                            action="/viewdatal/<?php echo $data[0]['id'];?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9  ">
                                                    <input type="text" name="address" class="form-control"
                                                        maxlength="25" value="<?php echo e(@$data[0]['address']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="pic_name" class="form-control"
                                                        value="<?php echo e(@$data[0]['pic_name']); ?>">>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="no_tlpn_pic" class="form-control"
                                                        value="<?php echo e(@$data[0]['no_tlpn_pic']); ?>">>
                                                </div>
                                            </div>
...
</html><?php /**PATH C:\Users\lutfiah aprilia\Downloads\web-pelaporan-master\resources\views/admin/editdatal.blade.php ENDPATH**/ ?>