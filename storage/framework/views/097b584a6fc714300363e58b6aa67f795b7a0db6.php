                            ...
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-lg-6 p-20 col-sm-offset-1">
                                        <form class="form-horizontal" method="POST" action="/viewdataladmin" enctype="multipart/form-data" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" name="no_tlpn_pic" class="form-control"
...
</html><?php /**PATH C:\Users\lutfiah aprilia\Downloads\web-pelaporan-master\resources\views/admin/formdatal.blade.php ENDPATH**/ ?>