                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e(@$item['category_instansi']); ?></td>
                                            <td>Haruka Persada</td>
                                            <td><?php echo e(@$item['pic_name']); ?></td>
                                            <td><?php echo e(@$item['date_instalation']); ?></td>
                                            <td><span class="label label-pink"><?php echo e(@$item['status']); ?></span></td>
                                            <td class="actions">
                                                <a href="/viewdataladmin/<?php echo e($item['id']); ?>/edit"
                                                    class="btn btn-icon waves-effect waves-light btn-success btn-xs m-b-5">
                                                    <i class="fa fa-pencil-square-o"></i></a>
                                                <a href="/viewdataladmin/<?php echo e($item['id']); ?>" class="btn btn-icon waves-effect waves-light btn-info btn-xs m-b-5"> <i class="fa fa-eye"></i> <span> Detail</span></a>
                                            </td>
                                        </tr>
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/admin/datainstalasi.blade.php ENDPATH**/ ?>