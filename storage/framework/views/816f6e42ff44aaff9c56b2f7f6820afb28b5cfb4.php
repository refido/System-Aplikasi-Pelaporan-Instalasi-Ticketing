                            ...
                            <div class="card-box">
                                <div class="row">
                                    <form class="form-horizontal" method="POST"
                                        action="/viewdataladmin/<?php echo $data[0]['id'];?>"
                                        ...
                                        <div class="col-lg-6 p-20 col-sm-offset-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    placeholder="Tidak ada data nama instansi">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="category_instansi" class="form-control"
                                                        value="<?php echo $data[0]['category_instansi'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9  ">
                                                    <input type="text" class="form-control"
                                                        maxlength="25" placeholder="tidak ada data alamat">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    value="<?php echo $data[0]['pic_name'];?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    value="<?php echo $data[0]['pic_phone'];?>">
                                                </div>
                                            </div>
                                        </div><!-- end col -->
                                        ...
                                        <div class="col-lg-5 p-20 ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control " name="date_instalation"
                                                        value="<?php echo $data[0]['date_instalation'];?>">
                                                    </div><!-- input-group -->
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    value="<?php echo $data[0]['technician_id'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    value="<?php echo $data[0]['number_of_technicians'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio radio-primary col-sm-offset-1">
                                                    <input type="radio" id="radio3" value="Open" checked>
                                                    <label for="radio3">
                                                        Open
                                                    </label>
                                                </div>
                                                <div class="radio radio-primary col-sm-offset-1">
                                                    <input type="radio" id="radio3" value="Proses">
                                                    <label for="radio3">
                                                        Proses
                                                    </label>
                                                </div>
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/admin/editdatal.blade.php ENDPATH**/ ?>