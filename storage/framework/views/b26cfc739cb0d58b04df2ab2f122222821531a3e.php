                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="row">
                                    <form class="form-horizontal" method="POST" action="/admtr/<?php echo $data[0]['id'];?>" enctype="multipart/form-data" role="form">
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="id_admin" class="form-control"
                                                        value="<?php echo e(@$data[0]['no_tlpn']); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="no_tlpn" class="form-control"
                                                        value="<?php echo e(@$data[0]['id_admin']); ?>">
                                                </div>
                                            </div>
                                    </div><!-- end col -->
...
</html><?php /**PATH C:\Users\lutfiah aprilia\Downloads\web-pelaporan-master\resources\views/editadministrator.blade.php ENDPATH**/ ?>