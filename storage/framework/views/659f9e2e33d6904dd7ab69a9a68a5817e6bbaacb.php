        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="m-b-30">
                            <a href="/viewlaptickmanager" type="button" class="btn btn-primary"><i class="fa fa-back">
                                </i>
                                Back</a>
                        </div>
                            ...
                            <div class="card-box table-responsive">
                                <div class="clearfix">
                                    <div class="pull-left col-sm-offset-1">
                                        <h4><?php echo e(@$data['instance_name']); ?><br>
                                            <strong><?php echo e(@$data['address']); ?></strong>
                                        </h4>
                                    </div>
                                    <div class="pull-left col-sm-offset-4">
                                        <h4>Kategori Instansi :
                                            <strong><?php echo e(@$data['category_id']); ?></strong>
                                        </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-10 ">
                                        <div class="pull-left m-t-30 col-sm-offset-2">
                                            ...
                                            <p><?php echo e(@$data['date_created']); ?></p><br>
                                        </div>
                                        <div class="pull-left m-t-30 col-sm-offset-2">
                                            <p><strong>No Ticket </strong> </p>
                                            <p><?php echo e(@$data['no_ticketing']); ?></p><br>
                                        </div>
                                        <div class="pull-left m-t-30 col-sm-offset-2">
                                            <p><strong>No Telepon Aduan</strong> </p>
                                            <p><?php echo e(@$data['no_tlpn']); ?></p><br>
                                        </div>
                                    </div><!-- end col -->
                                </div>
                                <hr>
                                    ...
                                    <div class="col-md-10 ">
                                        ...
                                        <!-- <div class="pull-right m-t-30 col-sm-offset-2">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates,
                                                ...
                                                itaque voluptas corrupti ratione reprehenderit magni similique? Tempore,
                                                quos
                                                delectus asperiores libero volutas quod perferendis! Voluptate, quod
                                                illo
                                                rerum? Lorem ipsum dolor sit amet.
                                            </p>
                                            <br>
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/manager/detailticketingmnj.blade.php ENDPATH**/ ?>