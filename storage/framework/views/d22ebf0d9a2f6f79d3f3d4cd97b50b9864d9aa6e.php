                                    ...
                                    <form class="form-horizontal" method="POST" action="/viewdatingadmin"
                                        ...
                                        <div class="col-lg-6 p-20 col-sm-offset-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2" id="component__id">
                                                        <optgroup label="Kategori Aduan">
                                                            ...
                                                            <option value="3">Digital Singage</option>
                                        ...
                                        <div class="col-lg-5 p-20 ">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-8 m-t-15">Status Aduan</label>
                                                <div class="col-sm-12">
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/admin/coba.blade.php ENDPATH**/ ?>