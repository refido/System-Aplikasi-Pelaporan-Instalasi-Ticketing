            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <h4 class="page-title">FORM DAFTAR TICKETING</h4>
                        </li>
                    </ul>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="row">
                                <form class="form-horizontal" method="POST" action="/viewdatingadmin"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="number" name="component_id" class="form-control"
                                                        placeholder="Masukkan component id">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 p-20 ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea style="width:600px; height:50px" name="problem" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group p-20">
                                                <div class="col-md-12 m-t-30">
                                                    <a href="/viewdatingadmin" type="submit"
                                                        ...
                                                        Aduan</a>
                                                    <button href="/viewdatingadmin" type="submit"
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/admin/formdating.blade.php ENDPATH**/ ?>