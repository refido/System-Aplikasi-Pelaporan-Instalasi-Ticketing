        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="m-b-30">
                            <a href="/viewdatingadmin" type="button" class="btn btn-primary"><i class="fa fa-back"> </i>
                                Back</a>
                        </div>
                            ...
                            <div class="card-box table-responsive">
                                <div class="clearfix">
                                    <div class="pull-left col-sm-offset-1">
                                        <h4><?php echo e(@$data[0]['instance_name']); ?><br>
                                            <strong><?php echo e(@$data[0]['address']); ?></strong>
                                        </h4>
                                    </div>
                                    <div class="pull-left col-sm-offset-4">
                                        <h4>Kategori Aduan :
                                            <strong><?php echo e(@$data[0]['name_components']); ?></strong>
                                        </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-10 ">
                                        <div class="pull-left m-t-30 col-sm-offset-2">
                                            ...
                                            <p><?php echo e(@$data[0]['date_created']); ?></p><br>
                                        </div>
                                        <div class="pull-left m-t-30 col-sm-offset-2">
                                            <p><strong>No Ticket </strong> </p>
                                            <p><?php echo e(@$data[0]['no_ticketing']); ?></p><br>
                                        </div>
                                        <div class="pull-left m-t-30 col-sm-offset-2">
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/admin/detailticketingadm.blade.php ENDPATH**/ ?>