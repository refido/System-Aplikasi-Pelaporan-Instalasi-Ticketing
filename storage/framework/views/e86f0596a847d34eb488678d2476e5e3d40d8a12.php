...
<body class="fixed-left">
    ...
    <div id="wrapper">
        ...
        <!-- ========== Left Sidebar Start ========== -->
        <?php echo $__env->make('manager.sbmanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Left Sidebar End -->
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-11 ">
                            <div class="m-b-30">
                                <a href="/viewlapinmanager" type="button" class="btn btn-primary"><i class="fa fa-back">
                                    </i>
                                    Back</a>
                            </div>
                            <div class="card-box task-detail col-sm-offset-1">
                                ...
                                <div class="row">
                                    <ul class="list-inline task-dates col-sm-offset-2">
                                        ...
                                        <li>
                                            ...
                                            <p> <?php echo e(@$data[0]['category_instansi']); ?></p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <ul class="list-inline task-dates col-sm-offset-2">
                                        <li>
                                            ...
                                            <p> <?php echo e(@$data[0]['start_installation']); ?> </p>
                                        </li>

                                        <li>
                                            <h5 class="font-600 m-b-5">Tanggal Selesai Instalasi</h5>
                                            <p> <?php echo e(@$data[0]['completed_installation']); ?></p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <ul class="list-inline task-dates m-b-0 m-t-20 col-sm-offset-2">
                                        <li>
                                            ...
                                            <p><?php echo e(@$data[0]['start_training']); ?></p>
                                        </li>

                                        <li>
                                            <h5 class="font-600 m-b-5">Tanggal Selesai Instalasi</h5>
                                            <p><?php echo e(@$data[0]['complete_training']); ?></p>
                                        </li>
                                    </ul>
                                </div><!-- end row -->
                                ...
                                <div class="row">
                                    <div class="col-md-10 ">
                                        ...
                                        <h5 class="font-600 m-b-5">Anydesk ID</h5>
                                            <p><?php echo e(@$data[0]['anydesk_id']); ?></p><br>
                                        </div>
                                ...
                                <p><?php echo e(@$data[0]['condition']); ?></p>
                                <br><br>

                                <!-- problem -->
                                <h5 class="font-600 m-b-20">Problem Instalasi</h5>
                                <p class="text-muted">
                                    <?php echo e(@$data[0]['problem']); ?>
                                                ...
                                                <div class="file-box col-sm-offset-2">
                                                    <a>
                                                        <video width="540" height="320" controls>
                                                            <source src="<?php echo e(@$data[0]['problem']); ?>"
                                                                type="video/mp4">
                                                        </video>
                                                    </a>
                                                    <p class="font-13 m-b-5 text-muted"><small></small></p>
...
</html><?php /**PATH D:\aplikasi\web-pelaporan-master\resources\views/manager/detaillapin.blade.php ENDPATH**/ ?>