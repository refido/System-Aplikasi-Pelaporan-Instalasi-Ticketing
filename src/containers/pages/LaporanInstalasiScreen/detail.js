      ...
      <View>
        <View style={styles.rowHeader}>
          ...
          <View style={styles.rowHome}>
            <Home
              onPress={() => {
                navigation.navigate('Menu', {user:user, token:token});
              }}
            />
          </View>
        </View>
